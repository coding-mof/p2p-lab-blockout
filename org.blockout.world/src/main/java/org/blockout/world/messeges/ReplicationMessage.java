...
public class ReplicationMessage implements IMessage {
	 ...
	 */
	private final ArrayList<IHash>	replicants;
	 ...
	 */
	public ReplicationMessage(final IMessage message, final IHash hash) {
	 ...
	 * @return
	 */
	public IMessage getMessage( final IHash hash ) {
	...
	public String toString() {
		return "ReplicationMessage[message=" + message + ", replicants=" + replicants + "]";
	}
}
